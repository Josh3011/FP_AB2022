...
library(imager)
setwd('/Users/joshaadrista/Downloads/Kuliah /Semester 5/AB/DATABASEPLAT_Master_Crop-3')
images <- list.files('/Users/joshaadrista/Downloads/Kuliah /Semester 5/AB/DATABASEPLAT_Master_Crop-3', pattern='jpg')
...
for(x in images){
  ...
  # Write CSV in R
  setwd('/Users/joshaadrista/Downloads/Kuliah /Semester 5/AB/CSV3')
  name <- strsplit(x, "[.]")[[1]][1]
  name2 <- ".csv"
